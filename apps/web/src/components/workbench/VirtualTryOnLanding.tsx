    ...
    <div className="flex min-h-0 flex-1 flex-col px-3 py-2 sm:px-5 lg:px-8">
      ...
      <div className="mx-auto flex w-full max-w-[1040px] flex-1 flex-col justify-center py-3">
        <div className="text-center">
          ...
          <div className="mt-3 flex items-center justify-center gap-3"><div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-rose-100 text-2xl dark:bg-rose-500/15">👗</div><h1 className="text-2xl font-black tracking-tight text-gray-900 dark:text-white sm:text-4xl">{publicText(workflowName, "AI试衣间")}</h1></div>
