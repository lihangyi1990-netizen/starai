...
const BUILTIN_LANGUAGE_META: Record<string, Pick<UILanguage, "short" | "name" | "flag">> = {
  ...
  "it-IT": { short: "IT", name: "Italiano", flag: "\u{1F1EE}\u{1F1F9}" },
};

const EXTRA_BUILTIN_TRANSLATIONS: Record<string, Record<string, string>> = {
  "zh-CN": {
    "模型不存在或未启用，请检查 model 是否为后台模型编码或接入模型名": "模型不存在或未启用，请检查模型名称。",
    "上游模型服务异常": "模型服务暂时不可用，请稍后重试。",
...
const BUILTIN_KEY_TRANSLATIONS: Record<string, Record<string, string>> = {
  // The ja/ko/vi entries in dictionaries.ts are still English placeholders, so the
  // account-password register strings get their real translations here instead.
  "login.descAccountOnly": { "en-US": "Log in with your email and password, or create a new account", "ja-JP": "メールアドレスとパスワードでログイン、または新規登録", "ko-KR": "이메일과 비밀번호로 로그인하거나 새 계정을 만드세요", "vi-VN": "Đăng nhập bằng email và mật khẩu, hoặc tạo tài khoản mới" },
  "login.loginTab": { "en-US": "Log in", "ja-JP": "ログイン", "ko-KR": "로그인", "vi-VN": "Đăng nhập" },
  "login.registerTab": { "en-US": "Register", "ja-JP": "新規登録", "ko-KR": "회원가입", "vi-VN": "Đăng ký" },
  "login.register": { "en-US": "Register", "ja-JP": "新規登録", "ko-KR": "회원가입", "vi-VN": "Đăng ký" },
  "login.registering": { "en-US": "Registering...", "ja-JP": "登録中…", "ko-KR": "가입 중...", "vi-VN": "Đang đăng ký..." },
  "login.registerFailed": { "en-US": "Registration failed, please try again later", "ja-JP": "登録に失敗しました。しばらくしてからお試しください", "ko-KR": "회원가입에 실패했습니다. 잠시 후 다시 시도해 주세요", "vi-VN": "Đăng ký thất bại, vui lòng thử lại sau" },
...
const BUILTIN_SOURCE_TRANSLATIONS: Record<string, Record<string, string>> = {
  "自定义": { "en-US": "Custom", "ja-JP": "カスタム", "ko-KR": "사용자 지정", "vi-VN": "Tùy chỉnh", "it-IT": "Personalizzato" },
  "自定义尺寸": { "en-US": "Custom size", "ja-JP": "カスタムサイズ", "ko-KR": "사용자 지정 크기", "vi-VN": "Kích thước tùy chỉnh", "it-IT": "Dimensione personalizzata" },
  "输入输出图片的宽度和高度（像素）": { "en-US": "Enter the output image width and height (pixels)", "ja-JP": "出力画像の幅と高さを入力（ピクセル）", "ko-KR": "출력 이미지 너비와 높이를 입력하세요(픽셀)", "vi-VN": "Nhập chiều rộng và chiều cao ảnh đầu ra (pixel)", "it-IT": "Inserisci larghezza e altezza dell'immagine (pixel)" },
  "宽度": { "en-US": "Width", "ja-JP": "幅", "ko-KR": "너비", "vi-VN": "Chiều rộng", "it-IT": "Larghezza" },
  "高度": { "en-US": "Height", "ja-JP": "高さ", "ko-KR": "높이", "vi-VN": "Chiều cao", "it-IT": "Altezza" },
  "范围 64-4096 像素，最大 1600 万像素": { "en-US": "64-4096 pixels; up to 16 million pixels", "ja-JP": "64～4096ピクセル、最大1600万ピクセル", "ko-KR": "64-4096픽셀, 최대 1,600만 픽셀", "vi-VN": "64-4096 pixel; tối đa 16 triệu pixel", "it-IT": "64-4096 pixel; massimo 16 milioni di pixel" },
  "宽度和高度需为 64-4096 的整数，且总像素不超过 1600 万": { "en-US": "Width and height must be integers from 64 to 4096, with no more than 16 million total pixels", "ja-JP": "幅と高さは64～4096の整数で、総ピクセル数は1600万以下にしてください", "ko-KR": "너비와 높이는 64-4096 사이의 정수이고 총 픽셀 수는 1,600만 이하여야 합니다", "vi-VN": "Chiều rộng và chiều cao phải là số nguyên từ 64 đến 4096, tổng không quá 16 triệu pixel", "it-IT": "Larghezza e altezza devono essere interi da 64 a 4096, per un massimo di 16 milioni di pixel" },
  "应用尺寸": { "en-US": "Apply size", "ja-JP": "サイズを適用", "ko-KR": "크기 적용", "vi-VN": "Áp dụng kích thước", "it-IT": "Applica dimensione" },
  "清除": { "en-US": "Clear", "ja-JP": "クリア", "ko-KR": "지우기", "vi-VN": "Xóa", "it-IT": "Cancella" },
  ...
  "模型不存在或未启用，请检查 model 是否为后台模型编码或接入模型名": { "en-US": "Model does not exist or is not enabled. Check the model name.", "ja-JP": "モデルが存在しないか、有効化されていません。モデル名を確認してください。", "ko-KR": "모델이 없거나 활성화되지 않았습니다. 모델 이름을 확인하세요.", "vi-VN": "Model không tồn tại hoặc chưa bật. Hãy kiểm tra tên model." },
  ...
  "上游模型服务异常": { "en-US": "Model service error", "ja-JP": "モデルサービスエラー", "ko-KR": "모델 서비스 오류", "vi-VN": "Lỗi dịch vụ model" },
