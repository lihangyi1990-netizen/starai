const STATIC_TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  "it-IT": {
    ...
    "legal.termsEmpty": "I Termini di servizio non sono ancora configurati. Contatta l'amministratore della piattaforma.",
    "legal.privacyEmpty": "L'Informativa sulla privacy non è ancora configurata. Contatta l'amministratore della piattaforma.",
  },
};
